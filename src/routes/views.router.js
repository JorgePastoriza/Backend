...
/*router.get('/session/products', async(req, res) =>{   
  ...
  result.prevLink = result.hasPrevPage?`http://localhost:8080/session/products?page=${result.prevPage}`:'';
  result.nextLink = result.hasNextPage?`http://localhost:8080/session/products?page=${result.nextPage}`:'';
