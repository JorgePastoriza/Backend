...
router.post('/login', async(req, res)=> {
    ...
    result.prevLink = result.hasPrevPage?`http://localhost:8080/api/sessions/products?page=${result.prevPage}`:'';
    result.nextLink = result.hasNextPage?`http://localhost:8080/api/sessions/products?page=${result.nextPage}`:'';
